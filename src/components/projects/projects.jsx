...
const projectsData = [
  {
    id: 'proyek-1',
    title: 'Portofolio Pribadi v1',
    description:
      'Website portofolio pertama saya, dibangun dari nol memakai HTML, CSS, dan JavaScript untuk berlatih dasar-dasar front-end.',
    tags: ['HTML', 'CSS', 'JavaScript'],
    image: '/images/projects/project-1.jpg',
    liveUrl: '',
    githubUrl: 'https://github.com/Ikhwan-stars',
    year: '2024',
  },
  {
    id: 'proyek-2',
    ...
    description:
      'Replikasi tampilan landing page modern untuk melatih penggunaan Tailwind CSS dan membiasakan diri dengan layout responsif.',
  ...
  },
  {
    ...
    description:
      'Website yang sedang kamu lihat sekarang — dibangun dengan React, Vite, Tailwind CSS v4, GSAP, dan Framer Motion.',
